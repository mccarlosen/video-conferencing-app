...
/* watch(selectedCamera, (newValue) => {
	deviceManager.setAudioInput(newValue);
	deviceManager.storeConstraints();
})
watch(selectedMicrophone, (newValue) => {
	deviceManager.setVideoInput(newValue);
	deviceManager.storeConstraints();
}) */
</script>

<template>
	<div class="max-w-sm shadow rounded-md p-5 space-y-5 border border-black">
		...
		<div class="w-full flex flex-col space-y-3">
			...
			<div class="select-wrapper">
				<select v-model="selectedCamera" id="cameras" class="select-field" :disabled="!enabledVideo">
		...
		<div class="w-full flex flex-col space-y-3">
			...
			<div class="select-wrapper">
				<select v-model="selectedMicrophone" id="microphones" class="select-field" :disabled="!enabledAudio">
